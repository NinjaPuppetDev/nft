...
.PHONY: all test clean deploy fund help install snapshot format anvil zktest deployCity
...
deploy:
	@forge script script/DeployNft.s.sol:DeployBasicNft $(NETWORK_ARGS)

mint:
	@forge script script/Interactions.s.sol:Interactions ${NETWORK_ARGS}

deployCity:
	@forge script script/DeployCitiesNft.s.sol:DeployCitiesNFT $(NETWORK_ARGS)
